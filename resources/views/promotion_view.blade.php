                                     ...
                                     <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                                      ...
                                      <div class="block1 wrap-pic-w">
                                        {{-- <input type="hidden" name="id_promo" value="{{$promos->id_promo}}"> --}}
                                            <img src="/promotion/{{$promo->img_promo}}" height="300" width="100"  alt="IMG-BANNER">

                                            <a href="/promoo/{{$promo->id_promo}}" class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
